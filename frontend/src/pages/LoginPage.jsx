...
const LoginPage = () => {
  ...
  return (
    <div className="relative h-full flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative w-full max-w-sm">
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-sm text-base-content/50 mt-1">Sign in to continue to Chatty</p>
        </div>
